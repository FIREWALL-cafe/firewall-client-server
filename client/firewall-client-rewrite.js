...
function init(storage) {
  ...
  console.log("%c %s", rainbowCSS, state);
  ...
  switch(state) {
    ...
    case states.WAITING_FOR_TRANSLATION:
      if(queryData.translation) {
        if(identity === 'baidu') searchTranslatedQuery()
